...
# Memory to hold recently-observed transitions
class ReplayMemory(object):
    ...
    # Select random batch of transitions for training
...
# Select action given the state and an epsilon greedy policy
...
# Helper function to visualize episode durations
def plot_durations():
    plt.figure(1)
    plt.clf()
...
if __name__ == '__main__':
    ...
    env = UnityEnvironment(filename="BottleFlip", seed=1, side_channels=[])
    ...
    # Set hyperparameters and utilities
    ...
    if torch.cuda.is_available():
        ...
        # Without GPU, 50 episodes are scheduled 
        num_episodes = 50
    ...
    for i_episode in range(num_episodes):
        ...
        for t in count():
            ...
            if done:
                # Save and visualize episode duration
